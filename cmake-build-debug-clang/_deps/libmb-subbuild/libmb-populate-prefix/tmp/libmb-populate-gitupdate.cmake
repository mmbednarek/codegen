...
execute_process(
  COMMAND "/usr/bin/git" show-ref "libmb-0.0.21"
  WORKING_DIRECTORY "/home/ego/projects/codegen/cmake-build-debug-clang/_deps/libmb-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "libmb-0.0.21")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("libmb-0.0.21" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/libmb-0.0.21")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ego/projects/codegen/cmake-build-debug-clang/_deps/libmb-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ego/projects/codegen/cmake-build-debug-clang/_deps/libmb-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
